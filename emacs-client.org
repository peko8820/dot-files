...
* Key Bindings
  ...
  I would like Command-W to close a frame, but only if it has a single
  window in it. I found this code on [[http://www.emacswiki.org/emacs/frame-cmds.el][this site]].
...
#+PROPERTY:    header-args+ :tangle ~/.emacs.d/elisp/init-client.el
